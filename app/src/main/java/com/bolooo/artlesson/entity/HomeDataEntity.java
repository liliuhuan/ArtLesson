...
public class HomeDataEntity implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeTypedList(this.DirectoryTypes);
        dest.writeTypedList(this.CourseShowResponses);
    }

    protected HomeDataEntity(Parcel in) {
        this.RecommandJson = in.readString();
        this.DirectoryTypes = in.createTypedArrayList(DirectoryTypesEntity.CREATOR);
        this.CourseShowResponses = in.createTypedArrayList(CourseShowResponsesEntity.CREATOR);
    }
