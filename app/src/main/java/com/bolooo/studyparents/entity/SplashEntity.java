package com.bolooo.studyparents.entity;
...
public class SplashEntity implements Parcelable {
    ...
    public static final Parcelable.Creator<SplashEntity> CREATOR = new Parcelable.Creator<SplashEntity>() {
        @Override
        public SplashEntity createFromParcel(Parcel source) {
